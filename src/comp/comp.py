...
c = [person.name for person in humans if ord(person.name[0]) in range(ord('C'),ord('G') + 1)]
print(c)
...
# joined to the age with a hyphen, for example "David-31", for all persons.
...
# Write a list comprehension that creates a list of new persons like the old
# list, except with all the names uppercase and the ages with 5 added to them.
# The "persons" list should be unmodified.
print("All names uppercase:")
g = [type(person)(person.name.upper(), person.age + 5) for person in humans]
print(g)
